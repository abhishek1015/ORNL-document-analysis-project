...
def parse(filename):
    ...
    def get_valid_reports_label(reports_json):
        ...
        valid_entries = [x for x in reports_json
                         ...
                         or x['gs_icd_label']['match_status']=="matched"
                         or x['gs_lat_label']['match_status']=="matched"
                         or x['gs_behavior_label']['match_status']=="matched"
                         or x['gs_hist_grade_label']['match_status']=="matched"]
        valid_labels = dict();
    ...
    valid_task_labels   = [ 'gs_organ_label', 
                        ...
                        'gs_behavior_label',
                        'gs_hist_grade_label'];
    reports_json = read_json(filename);
    reports_tuple_with_labels = get_valid_reports_label(reports_json);
    return reports_tuple_with_labels
"""
